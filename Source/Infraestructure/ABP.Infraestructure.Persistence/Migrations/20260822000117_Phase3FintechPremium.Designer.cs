...
namespace ABP.Infraestructure.Persistence.Migrations
{
    ...
    [Migration("20260822000117_Phase3FintechPremium")]
    partial class Phase3FintechPremium
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ABP.Core.Domain.Entities.ExternalPaymentTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("TargetSavingsAccountNumber")
                        .IsRequired()
                        .HasColumnType("text");

                    b.HasKey("Id");

                    b.ToTable("ExternalPayments", "artemisBankingPro");
                });
            ...
            modelBuilder.Entity("ABP.Core.Domain.Entities.IdentityVerificationDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("VerificationDocuments", "artemisBankingPro");
                });
            ...
            modelBuilder.Entity("ABP.Core.Domain.Entities.SavingsGoal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("AutoRoundupEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("SavingsGoals", "artemisBankingPro");
                });

            modelBuilder.Entity("ABP.Core.Domain.Entities.ScheduledPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ScheduledPayments", "artemisBankingPro");
                });
            ...
            modelBuilder.Entity("ABP.Core.Domain.Entities.UserBiometricCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BiometricCredentials", "artemisBankingPro");
                });

            modelBuilder.Entity("ABP.Core.Domain.Entities.VirtualCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("VirtualCards", "artemisBankingPro");
                });
